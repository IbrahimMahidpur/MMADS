...
4. For any model: print(classification_report), print(confusion_matrix), print(ROC‑AUC), print(feature importances)
5. Save ALL plots to disk with plt.savefig('filename.png', dpi=100, bbox_inches='tight')
6. Never call plt.show() — use matplotlib Agg backend always
7. Save trained models: joblib.dump(model, 'model.pkl')
8. End with a FINDINGS block: print('=== FINDINGS ===') then 3‑5 quantitative sentences
